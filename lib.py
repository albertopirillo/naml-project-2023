...
def balance_classes(data: np.ndarray, labels: np.ndarray, genre: str, seed: int = None) -> Tuple[np.ndarray, np.ndarray]:
...
def plot_confusion_matrix(true_labels: np.ndarray, pred_labels: np.ndarray, class_labels: List[str]) -> None:
